...
## Project Structure
    ...
    ├── testapiautoconnecto_96776  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_96776`
...
2. Clone this repo and `cd testapiautoconnecto_96776`
